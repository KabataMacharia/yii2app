        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>1.4. Customers will dial the provided Safaricom Skiza shortcut code <b>*811*998#</b> to download the tune. The downloaded ringtone will be played to & heard by the customers called (both safaricom subscribers & callers on other networks) from the time the connection to your line is made until when you pick up or disconnect the call.</p>
                    <p>1.5. The cost per tune will be as per the set Skiza price by Safaricom at <b>KES 1.50 per day.</b> The same is on daily auto renewal for a period of 30 days.</p>
                    <p>1.6. Upon downloading the tune the customers will receive a notification message from <b>‘SKIZA’</b>, showing the song downloaded, cost of tune renewal and how to unsubscribe from the tune.</p>
                    <p>1.7. Customers will be required to forward the received message from skiza to our short code number <b>‘20683’</b>, which will be used for the various draws to win the cash prize.</p>
                    <p>1.8. The promotion will run for a period of 3 months from <b>2nd July – 2nd October 2023.</b></p>
                    <p>1.9. There shall be monthly draws held to determine the monthly winners at the end of every month.
